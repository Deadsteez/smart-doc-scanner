  ...
  >
    ...
    <svg v-else class="w-4 h-4 text-gray-700" fill="currentColor" viewBox="0 0 20 20">
      ...
      <template v-if="user">
        ...
        <button
          @click="handleLogout"
          class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white border border-gray-300 dark:border-gray-700 hover:border-gray-400 dark:hover:border-gray-500 px-3 py-1.5 rounded-lg transition-colors"
        >
          Logout
        </button>
      </template>
