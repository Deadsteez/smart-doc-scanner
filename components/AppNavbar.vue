      ...
      <div :class="[
        ...
        <div class="flex items-center gap-8">
          <NuxtLink to="/" class="flex items-center gap-2.5 group">
            <div
              class="w-8 h-8 rounded-lg bg-accent-primary/15 flex items-center justify-center group-hover:bg-accent-primary/25 transition-colors">
              <svg class="w-4.5 h-4.5 text-accent-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                stroke-width="2">
