  ...
  <div class="p-6 max-w-4xl mx-auto">
    ...
    <div v-else class="space-y-6 mt-4">
      ...
      <div class="flex items-center justify-between flex-wrap gap-3">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="flex items-center gap-2">
            <span class="text-xs px-2.5 py-1 rounded-full uppercase tracking-wide font-medium" :class="categoryClass">
              {{ categoryType }}
            </span>
      ...
      <div v-if="extracted.items && extracted.items.length > 0"
        class="bg-bg-secondary border border-slate-1/50 rounded-xl p-5 shadow-card">
      ...
      <div class="bg-bg-secondary border border-slate-1/50 rounded-xl p-5 shadow-card">
        ...
        <pre
          class="bg-bg-primary  p-4 rounded-lg text-sm whitespace-pre-wrap text-text-secondary font-mono leading-relaxed max-h-96 overflow-y-auto">{{ doc.cleanedText }}</pre>
      </div>
    </div>
  </div>
</template>