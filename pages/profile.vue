...
<template>
  <div class="p-6 max-w-2xl mx-auto font-sans animate-fade-in">
    ...
    <div class="bg-bg-secondary border border-slate-1/40 rounded-2xl p-6 shadow-elevated mb-6 flex items-center gap-6">
    ...
    <div class="grid sm:grid-cols-2 gap-6 mb-8">
      ...
      <!-- Preferences -->
      <div class="bg-bg-secondary border border-slate-1/40 rounded-2xl p-6 shadow-elevated">
    ...
    <button
      @click="handleLogout"
      class="w-full bg-error/15 text-error hover:bg-error/25 font-medium py-3 rounded-xl transition-colors flex items-center justify-center gap-2"
    >
